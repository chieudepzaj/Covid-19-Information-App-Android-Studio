package com.developer.chieudepzaj.covid_19_info;
...
import com.developer.chieudepzaj.covid_19_info.R;
...
public class DetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Thông tin Covid_19 của "+AffectedCountries.countryModelsList.get(positionCountry).getCountry());
